...
function Button(props) {
  ...
  var _base = "inline-flex relative align-middle items-center font-medium content-center leading-4 text-center shadow-sm disabled:opacity-40 transform active:scale-95";
  ...
  let _justify = props.justify ? props.justify : 'center';
  ...
  const setup = () => {
    ...
    let variant, size, icon, iconSize, secondaryIcon, block, cursor, rounded, justify
    ...
    setBtnClasses( _base + " " + _focus + " " + _transition + " " + variant + " " + justify + "  " + size + " " + block + " " + cursor + " " + rounded + " " + _suffixClasses )
